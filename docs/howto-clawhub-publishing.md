...
Moved from root CLAUDE.md. Native OpenClaw skills live in
`openclaw/skills/gstack-openclaw-*/SKILL.md`. These are hand-crafted methodology
skills (not generated by the pipeline) published to ClawHub so any OpenClaw user
can install them.
